...
class TwitterTweet:
    ...
    def from_payload(cls, payload):
        ...
        user_data = payload.get('core', {}).get('user_results', {}).get('result', {}).get('legacy', {})
        ...
        return cls(
            ...
            hashtags=[tag['text'] for tag in entities_data.get('hashtags', [])],
            user_mentions=[mention['id_str'] for mention in entities_data.get('user_mentions', [])],
            urls=[url['expanded_url'] for url in entities_data.get('urls', [])]
        )
